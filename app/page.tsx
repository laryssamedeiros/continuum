  ...
  return (
    <main className={mainClasses}>
      ...
      <div className="pt-20">
        ...
        {currentPage === "pricing" && <PricingPage darkMode={darkMode} />}
      </div>
    </main>
  );
}
...
// Pricing Page
function PricingPage({ darkMode }: { darkMode: boolean }) {
  return (
    <div className="min-h-screen py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className={`p-8 rounded-3xl ${
            ...
            <ul className={`space-y-3 mb-8 ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
              <li>✓ Up to 5 exports per month</li>
              <li>✓ Export history (50 max)</li>
              <li>✓ All 3 LLM formats</li>
              <li>✓ Zero-knowledge encryption</li>
              <li>✓ Merge functionality</li>
            </ul>
            <button className={`w-full py-3 rounded-full border-2 font-medium transition-all ${
              darkMode
                ? "border-white/20 hover:bg-white/10"
                : "border-black/20 hover:bg-black/5"
            }`}>
          ...
          <div className={`p-8 rounded-3xl relative ${
            ...
            <div className="text-5xl font-bold mb-6">$9<span className="text-2xl">/mo</span></div>
            <ul className={`space-y-3 mb-8 ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
              <li>✓ Unlimited exports</li>
              <li>✓ Unlimited export history</li>
              <li>✓ Priority processing</li>
              <li>✓ Advanced merge analytics</li>
